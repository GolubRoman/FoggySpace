package com.golubroman.golub.foggyspace.Authentication.GetStartedPackage;
...
public class GetStartedActivity extends AppCompatActivity {
    ...
    @BindView(R.id.video) MyVideoView videoView;
    @BindView(R.id.btn_get_started) ImageView button_get_started;
    @BindView(R.id.welcome) TextView welcome_get_started;
